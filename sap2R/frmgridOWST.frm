...
Begin VB.Form frmgridOWST 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Data for OWSTs "
   ClientHeight    =   3870
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8940
   ...
   Begin VB.Frame frmOWST 
      Caption         =   "Enter the Data Required for the OWST(s)"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12
         Charset         =   0
   ...
   Begin VB.Label Label1 
      Caption         =   " Number of One Way Surge Tanks (OWSTs)"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
