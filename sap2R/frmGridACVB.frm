...
Begin VB.Form frmGridACVB 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Data for ACV"
   ClientHeight    =   3720
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6900
   ...
   Begin VB.Frame frmINRVs 
      Caption         =   "Enter the Data for ACV"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12
         Charset         =   0
   ...
   Begin VB.Label Label1 
      Caption         =   "Number of Air Cushion Valves "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
Private Sub Form_Load()
 ...
 Left = 20
 Top = 30
 myArray = Array("ACV No.", "Pipe No.", "Size  (mm)", "Chainage   (m)", "Pipe Invert Level (RL, m)")
   If NACVD > 0 Then
   ...
   Next
   If NACVD > 0 And Not OpenFile = "" Then
   For i = 1 To MSFlexGrid1.Rows - 1
