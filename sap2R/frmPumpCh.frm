...
Do Until EOF(1)
 ...
 End If
  NPUMPCH = NPUMPCH + 1
  PCH_Data(NPUMPCH - 1, 0) = check
  Input #1, PCH_Data(NPUMPCH - 1, 1), PCH_Data(NPUMPCH - 1, 2)
