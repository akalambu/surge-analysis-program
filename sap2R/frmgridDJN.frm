...
Begin VB.Form frmGridDJN 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Dividing Junction Details"
   ClientHeight    =   3750
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4830
   ...
   Begin VB.Frame frmINRVs 
      Caption         =   "Enter the Dividing Junction Details"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12
         Charset         =   0
