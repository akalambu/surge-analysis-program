...
Begin VB.Form frmGridUS 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Information of Upstream pipes"
   ClientHeight    =   3750
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   3645
...
Private Sub Form_Load()
   ...
   Dim myArray As Variant
    ...
    myArray = Array("Sl. No.", "U/S Pipes")

    Left = 20
    Top = 30
   
   MSFlexGrid1.Rows = NUSP(NoNode) + 1
   ...
   For j = 1 To MSFlexGrid1.Rows - 1
       If Not IUSP(NoNode, j) = 0 Then
       MSFlexGrid1.TextMatrix(j, 1) = IUSP(NoNode, j)
       End If
   Next
   'highlight 1st row
   HighLightGridRow (1)
