...
Private Sub Form_Load()
   ...
   myArray = Array("Stand Pipe No.", "Chainage   (m)", "Diameter (mm)", "Pipe Invert Level (RL, m)", "Top Level (RL, m)")
   If NSSD > 0 Then
   ...
   For i = 1 To MSFlexGrid1.Rows - 1
     For j = 1 To MSFlexGrid1.Cols - 1
       MSFlexGrid1.TextMatrix(i, j) = SP_Data(i - 1, j)
     Next
   Next
   End If
   'highlight 1st row
