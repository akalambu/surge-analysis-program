 ...
 For ii = 0 To (NNRVD - 1) Step 1
     For jj = 0 To 2 Step 1
        If Not IsNumeric(MSFlexGrid1.TextMatrix(ii + 1, jj + 1)) Then
         ...
         Exit For
         End If
         INR_Data(ii, jj + 1) = MSFlexGrid1.TextMatrix(ii + 1, jj + 1)
        Next
     If flag = 1 Then
      Exit For
     End If
...
Private Sub Form_Load()
   ...
   'set array
    myArray = Array("INRV No.", "Chainage   (m)", "Bypass Size (mm)", "Delay in Closure (sec)")
