...
Begin VB.Form frmGridDPC 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Data for DPCVs "
   ClientHeight    =   3975
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6480
   ...
   Begin VB.Frame frmDPC 
      Caption         =   "Enter the Data for DPCV(s)"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12
         Charset         =   0
   ...
   Begin VB.Label Label1 
      Caption         =   "Number of Dual Plate Check Valves (DPCVs)"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
Private Sub Form_Load()
   ...
   'set array
    ...
    myArray = Array("ZVV. No", "Chainage   (m)", "Bypass Size DPC (mm)")
