...
Begin VB.Form frmGrid2 
   Caption         =   "Data for One Way Surge Tank"
   ClientHeight    =   3870
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8940
   ...
   Begin VB.Label Label1 
      Caption         =   " Number of Oneway Surge Tanks"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
Private Sub Form_Load()
   ...
   'set array
    ...
    myArray = Array("OST No", "Chainage   (m)", "Ground Level (RL, m)", "Staging Height (m)", "Diameter   (mm)", "Storage Depth (m)", "Connecting Pipe Dia (mm)")
