...
NPRNT = 0
   For tst = 1 To (MSFlexGrid1.Rows - 1) Step 1
        If IsNumeric(MSFlexGrid1.TextMatrix(tst, 1)) Then
         NPRNT = NPRNT + 1
         CHPRNT(NPRNT) = MSFlexGrid1.TextMatrix(tst, 1)
        End If
   Next
...
If NPRNT > 0 Then
   ...
   For i = 1 To MSFlexGrid1.Rows - 1
       MSFlexGrid1.TextMatrix(i, 1) = CHPRNT(i)
     Next
   End If
End Sub
